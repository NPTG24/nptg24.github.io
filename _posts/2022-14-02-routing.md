...
En este caso ocupamos 'tun9' pues es por medio de VPN. En caso estuvieramos en una red local, deberíamos escribir por ejemplo, 'eth9'. Para terminar revisamos la nueva ruta por medio del siguiente comando:
