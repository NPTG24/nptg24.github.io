...
El script también incluye una variable llamada secret, que parece estar utilizada para la autorización en un servicio API Gateway, según el comentario en el código (#apigateway authorization for CR-124).
...
Al recargar la página web, observaremos que hemos iniciado sesión como el usuario administrador.
