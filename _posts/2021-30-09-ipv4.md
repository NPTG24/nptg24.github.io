...
2. Detectar cuantos bits se necesitan por hosts. Esto se calcula buscando la potencia base 2 que se mayor a la cantidad de hosts dada. Y los bits que se necesitan lo marcará el exponente de esta potencia.
